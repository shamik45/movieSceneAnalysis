...
public class mediaConnector implements ApplicationContextAware
{
    ...
    public String getMediaGuid(String id){
        ...
        String mediaUrlToCall = MEDIA_URL + "&token=" + token + "&byId=" + idToUse;
        ...
        guid = (String) ((JSONObject)mediaJson.getJSONArray("entries").get(0)).get("guid");

        log.info("guid for media for cid is = " + guid);
